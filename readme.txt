=== Plugin Name ===
Contributors: rksh8148
Donate link: http://sitextensions.com/
Tags: Post List, List, Posts, UI Post List, Post List Shortcode
...
1. Upload `wp-post-list-ui.zip` to the `/wp-content/plugins/` directory
...
1. This screen-shot shows the simple list of post lists. This screen also shows the "Add New List Button".
2. This screen-shot is to add new Post List. Here you can add your own code.
3. Screenshot to add new template and add code.
4. Shortcode sidebar after publish the post list.
